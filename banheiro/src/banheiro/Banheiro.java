...
//		//modificador que deve ser colocado em um método para que não possa ser executado por duas Threads ao mesmo tempo
//		synchronized (this) { //essa chave(this) também é chamado de mutex
...
//	}
	...
	public void fazNumeroUm() {
		...
		lock.lock(); //Explicitamente mostramos no código quando abre e quando fecha a porta da thread
